    ...
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:py-32">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {TESTIMONIALS.map((t) => (
          <div
            key={t.name}
            className="flex flex-col justify-between rounded-2xl border border-white/[0.08] bg-[#0F1A2E] p-7 shadow-[0_16px_48px_rgba(2,8,23,0.45)] ring-1 ring-white/[0.04] sm:p-8"
          >
            {/* Badge */}
            <div className="mb-5">
            ...
            {/* Quote */}
            <blockquote className="mb-6 flex-1 text-[15px] leading-[1.75] text-slate-300">
              &ldquo;{t.quote}&rdquo;
            </blockquote>
