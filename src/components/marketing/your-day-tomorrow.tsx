  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:py-32">
      ...
      <div className="mx-auto grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8">
        ...
        {/* After */}
        <div className="rounded-2xl border border-craftOrange/20 bg-[#0F1A2E] px-7 py-9 shadow-[0_0_40px_rgba(249,115,22,0.06)] sm:p-8">
          ...
          <ul className="space-y-7 sm:space-y-4">
            {AFTER.map((a) => (
              <li
                key={a}
                className="flex gap-3 text-base leading-[1.9] text-slate-200 sm:text-[15px] sm:leading-[1.7]"
              >
      ...
      <div className="mt-16 text-center sm:mt-14">
        <AuditDialog
          trigger={
            <Button
              size="lg"
              className="h-12 w-full bg-craftOrange px-6 text-[15px] font-semibold text-white shadow-lg shadow-craftOrange/20 hover:bg-craftOrange/90 sm:h-auto sm:w-auto sm:px-8 sm:text-base"
            >
